...
pub struct ReviewerSidecar {
    ...
    pending_dispatches: std::sync::Mutex<Vec<crate::hel_review::lanes::ReviewSubagentRequest>>,
}
...
impl ReviewerSidecar {
    ...
    pub fn record_dispatch(
        &self,
        dispatch: crate::hel_review::lanes::LaneDispatch,
    ) -> crate::hel_review::lanes::LaneDispatchReply {
        if let Err(message) = crate::hel_review::lanes::validate_dispatch(&dispatch.reviewers) {
            return crate::hel_review::lanes::LaneDispatchReply {
                started: Vec::new(),
                error: Some(message),
            };
        }
    ...
    #[must_use]
    pub fn take_dispatches(&self) -> Vec<crate::hel_review::lanes::ReviewSubagentRequest> {
        std::mem::take(
            &mut *self
                .pending_dispatches
                .lock()
    ...
    async fn dispatch(
        ...
        if let crate::hel_worker::ReviewerRequest::TakeLaneDispatches = request {
...
fn is_lane(role: &str) -> bool {
    crate::hel_review::lanes::lane_by_id(role).is_some()
}
