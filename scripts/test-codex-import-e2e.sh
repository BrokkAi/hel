...
test_root=${HEL_IMPORT_E2E_CODEX_ROOT:-"${XDG_STATE_HOME:-"$HOME/.local/state"}/hel/import-e2e/codex-native"}
...
export HEL_IMPORT_E2E_CODEX_SESSION="${HEL_IMPORT_E2E_CODEX_SESSION:-019feb6c-5ffc-7c12-ad99-bdeaeb6be79d}"
export HEL_IMPORT_E2E_CODEX_REPOSITORY="${HEL_IMPORT_E2E_CODEX_REPOSITORY:-BrokkAi/hel}"
