...
- [ ] (in progress) Milestone 2, second half — port mjolnir's tool-output layer: code tinting, `<details>` folds that build on first open, JSON reparsing, shell tokenising and language sniffing.
