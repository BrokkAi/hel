...
- [ ] (not started) Milestone 2 — Adopt the terminal surface's visual language, commit and wire the existing Markdown core, and port mjolnir's tool-output rendering layer on top of it.
